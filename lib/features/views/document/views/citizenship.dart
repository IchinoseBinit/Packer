...
class _CitizenshipSelectionState extends State<CitizenshipSelection> {
  ...
  Future<void> _pickCitizenshipImage() async {
    ...
    try {
      ...
      if (pickedFile != null) {
        ...
        print('Citizenship image saved: ${savedFile.path}');
      }
    } catch (e) {
      print('Error picking citizenship image: $e');
    }
  }
            ...
            Expanded(
              child: Center(
                child: Column(
                  ...
                  children: [
                    Text(
                      "TAKE PHOTO OF YOUR CITIZENSHIP CARD",
                    ...
                    Expanded(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ListTile(
                            title: Text('Citizenship Photo ${index + 1}'),
                            leading:
